...
const BathingTechnology = () => {
  return (
    <div className="bg-WhiteBath-3 w-full">
        <div className="max-w-[1400px] m-auto py-12">
            ...
            <div className="sm:flex block items-center gap-5">
                ...
                <div key={index} className="sm:h-auto h-[640px]">
                    <div className="">
                        <Image src={item.image} alt='Item Spa' width={480} height={644}/>
                    </div>
                    <div className="relative w-full sm:max-w-[420px] max-w-[320px] sm:mt-0 mt-2 m-auto text-center -top-[288px]">
                        <p className='text-white font-bold sm:text-3xl text-2xl pb-2'>{item.title}</p>
