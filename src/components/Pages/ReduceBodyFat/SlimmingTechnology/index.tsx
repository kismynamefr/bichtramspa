      ...
      <div className="max-w-[1400px] m-auto py-5 px-10 gap-10 flex items-center">
        ...
        <div className="sm:w-3/5 w-full">
          <div className="max-w-[650px] text-center">
            ...
            <h2 className='text-white text-justify text-base font-bold pb-4'>Trang thiết bị giảm béo tại Bích Trâm được nhập khẩu trực tiếp từ các tập đoàn thẩm mỹ hàng đầu ở Hoa Kỳ và châu Âu, đáp ứng tiêu chuẩn khắt khe nhất về chất lượng và độ an toàn, giúp khách hàng giảm béo trúng đích mà không tốn sức, không xâm lấn, không biến chứng.</h2>
          </div>
